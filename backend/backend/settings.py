...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'https://django-backend-86sb.onrender.com/']
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # Temporarily commented out for API testing
